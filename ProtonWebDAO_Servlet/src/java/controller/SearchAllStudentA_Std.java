...
public class SearchAllStudentA_Std extends HttpServlet
{
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
  {
    try 
    {
        ...
        Datalist = pd.searchAllProtonA_Std();
        ...
        out.println("<input type=\"radio\" onchange=\"orderAStd()\" name=\"txtStd1\" checked>Ascending</input>");
        ...
        out.println("<div>");
        out.println("<label for=\"filterStd1\">Search By Standard:</label>");
        out.println("<input type=\"radio\" onchange=\"orderAStd()\" name=\"txtStd2\" checked>Ascending</input>");
