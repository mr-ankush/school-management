...
public class SearchAllDeletedA_Std extends HttpServlet
{
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
  {
    try 
    {
        ...
        Datalist = pd.searchDeletedProtonA_Std();
        out.println("<html>");
        out.println("<head>");
        ...
        out.println("<style>code,td,h4{font-weight: bold;}input{cursor:pointer;}</style>");
        ...
        out.println("<form method=\"POST\" action=\"RestoreDataA_Std\">");
        ...
        out.println("</form>");
        out.println("</code></h4>");
        out.println("<a href=\"SearchAllDeletedA_Std\"><h5 class=\"text-center\" style=\"cursor:pointer;\"><code>Refresh</code></h5></a>");
        ...
        out.println("<input type=\"radio\" onchange=\"orderAStd_del()\" name=\"txtStd1\" checked>Ascending</input>");
        ...
        out.println("<div>");
        out.println("<label for=\"filterStd1\">Search By Standard:</label>");
        out.println("<input type=\"radio\" onchange=\"orderAStd_del()\" name=\"txtStd2\" checked>Ascending</input>");
