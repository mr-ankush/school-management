...
public class UpdateById extends HttpServlet
{
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
  {
    try 
    {
        ...
        if(P!=null)
        {
            out.println("<h2 class=\"text-center\" style=\"cursor:pointer;\"><u><b>Update Data - Student Form</b></u></h2>");
            out.println("<div class=\"col-sm-12 text-center\">");
            out.println("<code style=\"cursor:help;\">Student Id can\'t be change.</code><hr style=\"color:blue;\">");
            out.println("</div>");
            ...
            out.println("<input style=\"cursor:no-drop;\" type=\"text\" name=\"txtId\" value=\""+P.getId()+"\" placeholder=\"Enter Student Id\" disabled=\"true\"/>");
            out.println("<label for=\"name\">Student Name:</label>");
            out.println("<input type=\"text\" name=\"txtName\" value=\""+P.getName()+"\" placeholder=\"Enter Student Name\" required autocomplete=\"off\"/>");
            out.println("<label for=\"fname\">Father's Name:</label>");
            out.println("<input type=\"text\" name=\"txtFname\"  value=\""+P.getFname()+"\" placeholder=\"Enter Father's Name\" required autocomplete=\"off\"/>");
            out.println("<label for=\"Std\">Standard / Class:</label>");
            out.println("<input type=\"number\" name=\"txtStd\" value=\""+P.getStd()+"\" placeholder=\"Select Standard / Class\" min=\"1\" max=\"10\" required autocomplete=\"off\"/>");
            out.println("<label for=\"dob\">Date of Birth:</label>");
            out.println("<input type=\"date\" name=\"txtDob\" value=\""+P.getDob()+"\" required autocomplete=\"off\"/>");
            out.println("<label for=\"mobile\">Contact:</label>");
            out.println("<input type=\"tel\" name=\"txtMobile\" value=\""+P.getMobile()+"\" placeholder=\"Contact number without ISD code.\" maxlength=\"10\" required autocomplete=\"off\"/>");
            out.println("<label for=\"fee\">Yearly Fee:</label>");
            out.println("<input type=\"number\" name=\"txtFee\" value=\""+P.getFee()+"\" placeholder=\"Amount (in Rs.)\" min=\"1\" max=\"50000\" required autocomplete=\"off\"/>");
            out.println("<label for=\"address\">Address:</label>");
            out.println("<textarea width=\"100%\" name=\"txtAddress\" placeholder=\"Permanent Address\" required autocomplete=\"off\">"+P.getCity()+"</textarea>");
        ...
        out.println("<center><CODE><A href=ProtonPreSchool>Go to index page</A></CODE>&nbsp;&nbsp;&nbsp;<CODE><A href=UpdateById.html>Update Again / Go to back</A></CODE></center>");
        out.println("</div>");
        out.println("</div>");
        out.println("</body>");
        out.println("</html>");
