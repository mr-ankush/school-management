...
public class SearchAllStudentD_Std extends HttpServlet
{
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
  {
    try 
    {
        ...
        Datalist = pd.searchAllProtonD_Std();
        ...
        out.println("<style>code,td{font-weight: bold;}input{cursor:pointer;}</style>");
        ...
        out.println("<div class=\"col-sm-2\">");
        out.println("<CODE><A href=\"SearchAllDeletedA\">View Deleted Data</A></CODE></div>");
        out.println("</div>");
        out.println("<h2 class=\"text-center\" style=\"cursor:pointer;\"><u><b>Search All Data - Student</b></u></h2>");
        out.println("<div class=\"text-center\">");
        out.println("<div class=\"alert alert-info\">");
        out.println("<div>");
        out.println("<label for=\"filterId1\">Search By Id:</label>");
        out.println("<input type=\"radio\" onchange=\"orderAId()\" name=\"txtId1\">Ascending</input>");
        out.println("<input type=\"radio\" onchange=\"orderDId()\" name=\"txtId1\">Descending</input>");
        out.println("</div>");
        out.println("<div>");
        out.println("<label for=\"filterStd1\">Search By Standard:</label>");
        out.println("<input type=\"radio\" onchange=\"orderAStd()\" name=\"txtStd1\">Ascending</input>");
        out.println("<input type=\"radio\" onchange=\"orderDStd()\" name=\"txtStd1\" checked>Descending</input>");
        out.println("</div>");
        out.println("</div>");
        out.println("</div>");
        ...
        out.println("<input type=\"radio\" onchange=\"orderAId()\" name=\"txtId2\">Ascending</input>");
        out.println("<input type=\"radio\" onchange=\"orderDId()\" name=\"txtId2\">Descending</input>");
        out.println("</div>");
        out.println("<div>");
        out.println("<label for=\"filterStd1\">Search By Standard:</label>");
        out.println("<input type=\"radio\" onchange=\"orderAStd()\" name=\"txtStd2\">Ascending</input>");
        out.println("<input type=\"radio\" onchange=\"orderDStd()\" name=\"txtStd2\" checked>Descending</input>");
        out.println("</div>");
    ...
    {
        Logger.getLogger(SearchAllStudentD.class.getName()).log(Level.SEVERE, null,ex);
    }
  }
}