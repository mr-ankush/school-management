...
public class SearchAllStudentA extends HttpServlet
{
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
  {
    try 
    {
        ...
        out.println("<input type=\"radio\" onchange=\"orderAId()\" name=\"txtId1\" checked>Ascending</input>");
        ...
        out.println("<input type=\"radio\" onchange=\"orderAId()\" name=\"txtId2\" checked>Ascending</input>");
