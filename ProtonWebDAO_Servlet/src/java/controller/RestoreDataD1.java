...
public class RestoreDataD1 extends HttpServlet
{
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
  {
    try 
    {
        ...
        if(pd.deleteByIdProtonDeleted(id))
        {
            ...
            out.println("<a href=\"SearchAllStudentD\"><h5 class=\"text-center\" style=\"cursor:pointer;\"><code>View Restored Data</code></h5></a>");
