...
public class RestoreDataD_Std extends HttpServlet
{
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
  {
    try 
    {
        ...
        else
        {
            ...
            out.println("<form method=\"POST\" action=\"RestoreDataD_Std1\">");
            out.println("<input class=\"btn btn-sm btn-primary\" type=\"submit\" value=\"Restore Data\">");
            out.println("</form>");
            out.println("</td>");
            out.println("<td width=\"150px\">");
            out.println("<form method=\"GET\" action=\"SearchAllDeletedD_Std\">");
