...
public class SearchAllStudentD extends HttpServlet
{
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
  {
    try 
    {
        ...
        out.println("<input type=\"radio\" onchange=\"orderDId()\" name=\"txtId1\" checked>Descending</input>");
        out.println("</div>");
        out.println("<div>");
        ...
        out.println("<input type=\"radio\" onchange=\"orderDStd()\" name=\"txtStd1\">Descending</input>");
        out.println("</div>");
        out.println("</div>");
        out.println("</div>");
        ...
        out.println("<input type=\"radio\" onchange=\"orderDId()\" name=\"txtId2\" checked>Descending</input>");
        out.println("</div>");
        out.println("<div>");
        out.println("<label for=\"filterStd1\">Search By Standard:</label>");
        out.println("<input type=\"radio\" onchange=\"orderAStd()\" name=\"txtStd2\">Ascending</input>");
        out.println("<input type=\"radio\" onchange=\"orderDStd()\" name=\"txtStd2\">Descending</input>");
        out.println("</div>");
